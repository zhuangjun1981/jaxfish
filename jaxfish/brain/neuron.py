import random
import numpy as np
from jaxfish.utils import save_h5_dataset
...
class Eye(Neuron):
    ...
    def get_data_dict(self):
        ...
        data_dict["neuron_type"] = "eye"
        data_dict["eye_direction"] = self.eye_direction
        data_dict["rf_positions"] = self.rf_positions
        data_dict["rf_weights"] = self.rf_weights
        data_dict["gain"] = self.gain
        return data_dict
...
class Muscle(Neuron):
    ...
    def get_data_dict(self):
        data_dict = super().get_data_dict()
        data_dict["neuron_type"] = "muscle"
        data_dict["direction"] = self.direction
        data_dict["step_motion"] = self.step_motion
